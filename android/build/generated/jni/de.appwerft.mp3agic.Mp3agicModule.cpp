...
// Methods --------------------------------------------------------------------
void Mp3agicModule::getAlbumimage(const FunctionCallbackInfo<Value>& args)
{
	...
	if (args.Length() < 1) {
		...
		sprintf(errorStringBuffer, "getAlbumimage: Invalid number of arguments. Expected 1 but got %d", args.Length());
...
void Mp3agicModule::getId3Tag(const FunctionCallbackInfo<Value>& args)
{
	LOGD(TAG, "getId3Tag()");
	Isolate* isolate = args.GetIsolate();
	Local<Context> context = isolate->GetCurrentContext();
	...
	if (args.Length() < 1) {
		char errorStringBuffer[100];
		sprintf(errorStringBuffer, "getId3Tag: Invalid number of arguments. Expected 1 but got %d", args.Length());
		titanium::JSException::Error(isolate, errorStringBuffer);
		return;
	}
...
void Mp3agicModule::getId3v2Tag(const FunctionCallbackInfo<Value>& args)
{
	...
	if (args.Length() < 1) {
		char errorStringBuffer[100];
		sprintf(errorStringBuffer, "getId3v2Tag: Invalid number of arguments. Expected 1 but got %d", args.Length());
		titanium::JSException::Error(isolate, errorStringBuffer);
		return;
	}
...
void Mp3agicModule::getId3v1Tag(const FunctionCallbackInfo<Value>& args)
{
	...
	if (args.Length() < 1) {
		char errorStringBuffer[100];
		sprintf(errorStringBuffer, "getId3v1Tag: Invalid number of arguments. Expected 1 but got %d", args.Length());
		titanium::JSException::Error(isolate, errorStringBuffer);
		return;
	}
